...
export default function ClientesEdit({ cliente }: Props) {
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: 'Editar', href: `/clientes/${cliente.id}/edit` },
    ];
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title={`Editar - ${cliente.nombres} ${cliente.apellidos}`} />
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-muted-foreground">
                            Modifica los datos del cliente {cliente.nombres} {cliente.apellidos}
                        </p>
                    </div>
                </div>
